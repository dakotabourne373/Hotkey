...
export const SortableHotkeyList: FC<SortableHotkeyList.Props> = ({ data: originalList, connectionBannerProps, onFinishSorting }) => {
    const [data, setData] = useState([...originalList.map((item, index) => ({ ...item, key: `${index}` }))]);
    ...
    return (
        <SafeAreaView style={{
            ...
            <ScrollView scrollEnabled={scrollEnabled}>
                <>
                    ...
                    <View style={{ flexDirection: 'row-reverse', justifyContent: 'space-between', padding: 16 }}>
                        <Button style={{ borderRadius: 10, padding: 2, paddingHorizontal: 4, alignContent: 'center', justifyContent: 'center' }} disabled>
                ...
                <DraggableGrid
                    ...
                    renderItem={(item) => (
                        <View
                            ...
                            style={{ width: '100%', flex: 1, paddingHorizontal: 16, margin: 4, borderRadius: 10, borderStyle: 'dashed', borderWidth: 1, borderColor: 'white', alignItems: 'center', alignContent: 'center', justifyContent: 'space-around', backgroundColor: '#3c3f44' }}
                        >
            ...
            <Button style={{ margin: 16 }} onPress={() => {
